...
const { Meta } = Card;
const tmpdata = ethers.utils.getAddress("0x464e3F471628E162FA34F130F4C3bCC41fF7635d");
const collection = {
  name: "fsdf",
  symbol: "fsdf",
  treasury:  tmpdata,
...
function NFTBalance() {
  ...
  const { chainId,marketAddress,contractABI, creatorAddress, contractABI2 } = useMoralisDapp();
  ...
  const contractABIJson1 = JSON.parse(contractABI2);
  const contractABIJson = JSON.parse(contractABI);

  const listItemFunction = "createMarketItem";
  const DeployNFTcontract = "createDropCollection"
  ...
  async function CreateCollection(collection) {
    ...
    const ops = {
      ...
      abi: contractABIJson1,
      params: {
        name: collection.name,
        symbol: collection.symbol,
        treasury: collection.treasury,
        royalty: collection.royalty,
        royaltyFee: collection.royaltyFee,
        // RoyaltyFree: Web3.utils.soliditySha3({type: 'uint96', value: tmpdata2}),
      },
    };
    ...
    <>
            ...
            <Card
              ...
              cover={
                <Image
                  ...
                  alt=""
                  style={{ height: "240px",borderRadius: "20px" }}
                />
              }
              key={index}
            >
      ...
      <Modal
        ...
        footer={[
          ...
          //   Approve
          // </Button>,
          <Button onClick={() => CreateCollection(collection)} type="primary">
            create Collection
          </Button>
        ]}
      >
