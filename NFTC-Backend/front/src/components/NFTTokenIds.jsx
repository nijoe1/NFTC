...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  const { NFTTokenIds, totalNFTs,collectionDescription, fetchSuccess } = useNFTTokenIds(inputValue);
            ...
            <div style={styles.banner}>
              ...
              <div style={styles.text}>
                <>
                  ...
                  >
                    <div display="block"  marginTop="300px">
              ...
              <Card
                ...
                cover={
                  <Image
                    ...
                    fallback={fallbackImg}
                    alt=""
                    style={{ height: "240px",borderRadius: "20%" }}
                  />
                }
                key={index}
              >
